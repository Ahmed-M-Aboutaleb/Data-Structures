...
void fillTree(Tree *tree) {
    ...
    n81->data = 81; n81->right = NULL; n81->left = NULL;
    n22->data = 22; n22->right = n81; n22->left = NULL;
    n6->data = 6; n6->right = NULL; n6->left = NULL;
    n41->data = 41; n41->right = n6; n41->left = n22;
    n18->data = 18; n18->right = NULL; n18->left = NULL;
    n9->data = 9; n9->right = NULL; n9->left = n18;
    n17->data = 17; n17->right = n9; n17->left = n41;
    *tree = n17;
}
